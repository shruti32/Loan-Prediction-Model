...
The GLM model using caret function gives the maximum AUC (.78) among all the GLMs.
...
The AUC of KNN model using knn() function is same as that of full GLM model (.75). The AUC of KNN model using caret package is same as that of GLM model developed using caret package.
